...
import { Bug, Lightbulb, DollarSign, Award } from 'lucide-react';
    ...
    <div className="container mx-auto px-4 py-12 md:px-6 md:py-24 animate-in fade-in slide-in-from-bottom-12 duration-1000">
      ...
      <Card className="mb-16">
        <CardHeader>
          <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4">
              <div>
                <CardTitle className="font-headline flex items-center gap-2"><Award className="h-6 w-6 text-primary"/> CTF Events & Rankings</CardTitle>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="flex flex-col">
          ...
          {/* make scrollable, show up to 4 items */}
